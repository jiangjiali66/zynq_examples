...
`timescale 1 ns / 1 ps
	...
	module Quadrature_Encoder_IP_v1_0 #
	(
...
// Instantiation of Axi Bus Interface S00_AXI
	Quadrature_Encoder_IP_v1_0_S00_AXI # ( 
        .CLK_FREQUENCY            (16'd100),           //input clock frequency in MHz
        .PWM_PERIOD                   (16'd2000),      //PWM period set, in uS, maximum value is 32767
        .SPEED_CTRL_PERIOD    (16'd25),    //speed control period,   means  the number of PWM period
        .C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) Quadrature_Encoder_IP_v1_0_S00_AXI_inst (
