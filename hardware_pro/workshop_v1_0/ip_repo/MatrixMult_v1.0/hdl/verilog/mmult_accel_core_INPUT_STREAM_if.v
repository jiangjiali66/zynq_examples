...
module mmult_accel_core_INPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
...
//------------------------Instantiation------------------
// rs
mmult_accel_core_INPUT_STREAM_reg_slice #(
    .N       ( 55 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
mmult_accel_core_INPUT_STREAM_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) in_stream_data_V_fifo (
    .clk        ( ACLK ),
...
module mmult_accel_core_INPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module mmult_accel_core_INPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
