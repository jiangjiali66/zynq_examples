...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name mmult_accel_core_ap_fmul_2_max_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name mmult_accel_core_ap_fmul_2_max_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips mmult_accel_core_ap_fmul_2_max_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis simulation} [get_files mmult_accel_core_ap_fmul_2_max_dsp.xci]
