...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set M_left_phA [ create_bd_port -dir I M_left_phA ]
  set M_left_phB [ create_bd_port -dir I M_left_phB ]
  set M_right_phA [ create_bd_port -dir I M_right_phA ]
  set M_right_phB [ create_bd_port -dir I M_right_phB ]
  ...
  # Create instance: Quadrature_Encoder_IP_v1_0_0, and set properties
  set Quadrature_Encoder_IP_v1_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:xup:Quadrature_Encoder_IP_v1_0:1.0 Quadrature_Encoder_IP_v1_0_0 ]

  # Create instance: Ultrasonic_ip_v1_0_0, and set properties
  set Ultrasonic_ip_v1_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:xup:Ultrasonic_ip_v1_0:1.0 Ultrasonic_ip_v1_0_0 ]
  ...
  set_property -dict [ list CONFIG.c_include_sg {0} CONFIG.c_mm2s_burst_size {256} CONFIG.c_s2mm_burst_size {256} CONFIG.c_sg_include_stscntrl_strm {0} CONFIG.c_sg_length_width {23}  ] $axi_dma_1

  # Create instance: axi_gpio_0, and set properties
  set axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0 ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS_2 {0} CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_GPIO2_WIDTH {8} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_INTERRUPT_PRESENT {1} CONFIG.C_IS_DUAL {1}  ] $axi_gpio_0

  # Create instance: axi_gpio_1, and set properties
  set axi_gpio_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_1 ]
  set_property -dict [ list CONFIG.C_GPIO_WIDTH {4} CONFIG.C_INTERRUPT_PRESENT {1}  ] $axi_gpio_1

  # Create instance: axi_gpio_2, and set properties
  set axi_gpio_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_2 ]
  set_property -dict [ list CONFIG.C_GPIO2_WIDTH {6} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_INTERRUPT_PRESENT {1} CONFIG.C_IS_DUAL {1}  ] $axi_gpio_2
  ...
  # Create instance: mmult_accel_core_0, and set properties
  set mmult_accel_core_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mmult_accel_core:1.0 mmult_accel_core_0 ]
...
CONFIG.PCW_ACT_CAN_PERIPHERAL_FREQMHZ {100.000000} CONFIG.PCW_ACT_DCI_PERIPHERAL_FREQMHZ {10.096154} \
CONFIG.PCW_ACT_ENET0_PERIPHERAL_FREQMHZ {125.000000} CONFIG.PCW_ACT_ENET1_PERIPHERAL_FREQMHZ {10.000000} \
CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {100.000000} CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {175.000000} \
...
CONFIG.PCW_CAN0_CAN0_IO {MIO 14 .. 15} CONFIG.PCW_CAN0_GRP_CLK_ENABLE {0} \
...
CONFIG.PCW_CAN_PERIPHERAL_DIVISOR0 {10} CONFIG.PCW_CAN_PERIPHERAL_DIVISOR1 {1} \
CONFIG.PCW_CAN_PERIPHERAL_FREQMHZ {100} CONFIG.PCW_CAN_PERIPHERAL_VALID {1} \
CONFIG.PCW_CLK0_FREQ {100000000} CONFIG.PCW_CLK1_FREQ {175000000} \
...
CONFIG.PCW_EN_EMIO_TTC1 {0} CONFIG.PCW_EN_EMIO_UART0 {1} \
...
CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {6} CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {1} \
...
CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100.000000} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {175.000000} \
...
CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Users/harryfan/Desktop/ZYBO_zynq_def.xml} CONFIG.PCW_INCLUDE_ACP_TRANS_CHECK {0} \
...
CONFIG.PCW_MIO_45_SLEW {fast} CONFIG.PCW_MIO_46_DIRECTION {inout} \
...
CONFIG.PCW_MIO_6_SLEW {fast} CONFIG.PCW_MIO_7_DIRECTION {out} \
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#SPI 1#SPI 1#SPI 1#SPI 1#CAN 0#CAN 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#mosi#miso#sclk#ss[0]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.PCW_SPI1_BASEADDR {0xE0007000} CONFIG.PCW_SPI1_GRP_SS0_ENABLE {1} \
CONFIG.PCW_SPI1_GRP_SS0_IO {MIO 13} CONFIG.PCW_SPI1_GRP_SS1_ENABLE {0} \
...
CONFIG.PCW_SPI_PERIPHERAL_CLKSRC {IO PLL} CONFIG.PCW_SPI_PERIPHERAL_DIVISOR0 {6} \
...
CONFIG.PCW_S_AXI_ACP_FREQMHZ {100} CONFIG.PCW_S_AXI_ACP_ID_WIDTH {3} \
...
CONFIG.PCW_UART0_UART0_IO {EMIO} CONFIG.PCW_UART1_BASEADDR {0xE0001000} \
...
CONFIG.PCW_USE_PS_SLCR_REGISTERS {0} CONFIG.PCW_USE_S_AXI_ACP {1} \
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  set_property -dict [ list CONFIG.NUM_MI {10}  ] $processing_system7_0_axi_periph
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mmult_accel_core_0/INPUT_STREAM]
  ...
  connect_bd_intf_net -intf_net mmult_accel_core_0_OUTPUT_STREAM [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins mmult_accel_core_0/OUTPUT_STREAM]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins Quadrature_Encoder_IP_v1_0_0/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins Ultrasonic_ip_v1_0_0/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M07_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M08_AXI [get_bd_intf_pins mmult_accel_core_0/S_AXI_CONTROL_BUS] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M09_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins processing_system7_0_axi_periph/M09_AXI]

  # Create port connections
  connect_bd_net -net M_left_phA_1 [get_bd_ports M_left_phA] [get_bd_pins Quadrature_Encoder_IP_v1_0_0/M_left_phA]
  connect_bd_net -net M_left_phB_1 [get_bd_ports M_left_phB] [get_bd_pins Quadrature_Encoder_IP_v1_0_0/M_left_phB]
  connect_bd_net -net M_right_phA_1 [get_bd_ports M_right_phA] [get_bd_pins Quadrature_Encoder_IP_v1_0_0/M_right_phA]
  connect_bd_net -net M_right_phB_1 [get_bd_ports M_right_phB] [get_bd_pins Quadrature_Encoder_IP_v1_0_0/M_right_phB]
  connect_bd_net -net Ultrasonic_ip_v1_0_0_trig [get_bd_ports trig] [get_bd_pins Ultrasonic_ip_v1_0_0/trig]
  ...
  connect_bd_net -net axi_dma_1_s2mm_introut [get_bd_pins axi_dma_1/s2mm_introut] [get_bd_pins xlconcat_0/In8]
  ...
  connect_bd_net -net echo_1 [get_bd_ports echo] [get_bd_pins Ultrasonic_ip_v1_0_0/echo]
  connect_bd_net -net mmult_accel_core_0_interrupt [get_bd_pins mmult_accel_core_0/interrupt] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Quadrature_Encoder_IP_v1_0_0/s00_axi_aclk] [get_bd_pins Ultrasonic_ip_v1_0_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_pwm_6ch_0/s00_axi_aclk] [get_bd_pins mmult_accel_core_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/M08_ACLK] [get_bd_pins processing_system7_0_axi_periph/M09_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins Quadrature_Encoder_IP_v1_0_0/s00_axi_aresetn] [get_bd_pins Ultrasonic_ip_v1_0_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_pwm_6ch_0/s00_axi_aresetn] [get_bd_pins mmult_accel_core_0/aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M09_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Quadrature_Encoder_IP_v1_0_0/s00_axi/reg0] SEG_Quadrature_Encoder_IP_v1_0_0_reg0
  create_bd_addr_seg -range 0x10000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Ultrasonic_ip_v1_0_0/s00_axi/reg0] SEG_Ultrasonic_ip_v1_0_0_reg0
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mmult_accel_core_0/S_AXI_CONTROL_BUS/Reg] SEG_mmult_accel_core_0_Reg
