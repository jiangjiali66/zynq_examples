...
module system_wrapper
  ...
  inout [7:0]gpio1_0_tri_io;
  inout [7:0]gpio2_0_tri_io;
  ...
  wire [4:4]gpio1_0_tri_i_4;
  wire [5:5]gpio1_0_tri_i_5;
  wire [6:6]gpio1_0_tri_i_6;
  wire [7:7]gpio1_0_tri_i_7;
  wire [0:0]gpio1_0_tri_io_0;
  wire [1:1]gpio1_0_tri_io_1;
  wire [2:2]gpio1_0_tri_io_2;
  wire [3:3]gpio1_0_tri_io_3;
  wire [4:4]gpio1_0_tri_io_4;
  wire [5:5]gpio1_0_tri_io_5;
  wire [6:6]gpio1_0_tri_io_6;
  wire [7:7]gpio1_0_tri_io_7;
  wire [0:0]gpio1_0_tri_o_0;
  wire [1:1]gpio1_0_tri_o_1;
  wire [2:2]gpio1_0_tri_o_2;
  wire [3:3]gpio1_0_tri_o_3;
  wire [4:4]gpio1_0_tri_o_4;
  wire [5:5]gpio1_0_tri_o_5;
  wire [6:6]gpio1_0_tri_o_6;
  wire [7:7]gpio1_0_tri_o_7;
  wire [0:0]gpio1_0_tri_t_0;
  wire [1:1]gpio1_0_tri_t_1;
  wire [2:2]gpio1_0_tri_t_2;
  wire [3:3]gpio1_0_tri_t_3;
  wire [4:4]gpio1_0_tri_t_4;
  wire [5:5]gpio1_0_tri_t_5;
  wire [6:6]gpio1_0_tri_t_6;
  wire [7:7]gpio1_0_tri_t_7;
  wire [0:0]gpio2_0_tri_i_0;
  wire [1:1]gpio2_0_tri_i_1;
  wire [2:2]gpio2_0_tri_i_2;
  wire [3:3]gpio2_0_tri_i_3;
  wire [4:4]gpio2_0_tri_i_4;
  wire [5:5]gpio2_0_tri_i_5;
  wire [6:6]gpio2_0_tri_i_6;
  wire [7:7]gpio2_0_tri_i_7;
  wire [0:0]gpio2_0_tri_io_0;
  wire [1:1]gpio2_0_tri_io_1;
  wire [2:2]gpio2_0_tri_io_2;
  wire [3:3]gpio2_0_tri_io_3;
  wire [4:4]gpio2_0_tri_io_4;
  wire [5:5]gpio2_0_tri_io_5;
  wire [6:6]gpio2_0_tri_io_6;
  wire [7:7]gpio2_0_tri_io_7;
  wire [0:0]gpio2_0_tri_o_0;
  wire [1:1]gpio2_0_tri_o_1;
  wire [2:2]gpio2_0_tri_o_2;
  wire [3:3]gpio2_0_tri_o_3;
  wire [4:4]gpio2_0_tri_o_4;
  wire [5:5]gpio2_0_tri_o_5;
  wire [6:6]gpio2_0_tri_o_6;
  wire [7:7]gpio2_0_tri_o_7;
  wire [0:0]gpio2_0_tri_t_0;
  wire [1:1]gpio2_0_tri_t_1;
  wire [2:2]gpio2_0_tri_t_2;
  wire [3:3]gpio2_0_tri_t_3;
  wire [4:4]gpio2_0_tri_t_4;
  wire [5:5]gpio2_0_tri_t_5;
  wire [6:6]gpio2_0_tri_t_6;
  wire [7:7]gpio2_0_tri_t_7;
...
IOBUF gpio1_0_tri_iobuf_3
       (.I(gpio1_0_tri_o_3),
        ...
        .O(gpio1_0_tri_i_3),
        .T(gpio1_0_tri_t_3));
IOBUF gpio1_0_tri_iobuf_4
       (.I(gpio1_0_tri_o_4),
        .IO(gpio1_0_tri_io[4]),
        .O(gpio1_0_tri_i_4),
        .T(gpio1_0_tri_t_4));
IOBUF gpio1_0_tri_iobuf_5
       (.I(gpio1_0_tri_o_5),
        .IO(gpio1_0_tri_io[5]),
        .O(gpio1_0_tri_i_5),
        .T(gpio1_0_tri_t_5));
IOBUF gpio1_0_tri_iobuf_6
       (.I(gpio1_0_tri_o_6),
        .IO(gpio1_0_tri_io[6]),
        .O(gpio1_0_tri_i_6),
        .T(gpio1_0_tri_t_6));
IOBUF gpio1_0_tri_iobuf_7
       (.I(gpio1_0_tri_o_7),
        .IO(gpio1_0_tri_io[7]),
        .O(gpio1_0_tri_i_7),
        .T(gpio1_0_tri_t_7));
...
IOBUF gpio2_0_tri_iobuf_3
       (.I(gpio2_0_tri_o_3),
        ...
        .O(gpio2_0_tri_i_3),
        .T(gpio2_0_tri_t_3));
IOBUF gpio2_0_tri_iobuf_4
       (.I(gpio2_0_tri_o_4),
        .IO(gpio2_0_tri_io[4]),
        .O(gpio2_0_tri_i_4),
        .T(gpio2_0_tri_t_4));
IOBUF gpio2_0_tri_iobuf_5
       (.I(gpio2_0_tri_o_5),
        .IO(gpio2_0_tri_io[5]),
        .O(gpio2_0_tri_i_5),
        .T(gpio2_0_tri_t_5));
IOBUF gpio2_0_tri_iobuf_6
       (.I(gpio2_0_tri_o_6),
        .IO(gpio2_0_tri_io[6]),
        .O(gpio2_0_tri_i_6),
        .T(gpio2_0_tri_t_6));
IOBUF gpio2_0_tri_iobuf_7
       (.I(gpio2_0_tri_o_7),
        .IO(gpio2_0_tri_io[7]),
        .O(gpio2_0_tri_i_7),
        .T(gpio2_0_tri_t_7));
...
system system_i
       (.DDR_addr(DDR_addr),
        ...
        .GPIO1_0_tri_i({gpio1_0_tri_i_7,gpio1_0_tri_i_6,gpio1_0_tri_i_5,gpio1_0_tri_i_4,gpio1_0_tri_i_3,gpio1_0_tri_i_2,gpio1_0_tri_i_1,gpio1_0_tri_i_0}),
        .GPIO1_0_tri_o({gpio1_0_tri_o_7,gpio1_0_tri_o_6,gpio1_0_tri_o_5,gpio1_0_tri_o_4,gpio1_0_tri_o_3,gpio1_0_tri_o_2,gpio1_0_tri_o_1,gpio1_0_tri_o_0}),
        .GPIO1_0_tri_t({gpio1_0_tri_t_7,gpio1_0_tri_t_6,gpio1_0_tri_t_5,gpio1_0_tri_t_4,gpio1_0_tri_t_3,gpio1_0_tri_t_2,gpio1_0_tri_t_1,gpio1_0_tri_t_0}),
        .GPIO2_0_tri_i({gpio2_0_tri_i_7,gpio2_0_tri_i_6,gpio2_0_tri_i_5,gpio2_0_tri_i_4,gpio2_0_tri_i_3,gpio2_0_tri_i_2,gpio2_0_tri_i_1,gpio2_0_tri_i_0}),
        .GPIO2_0_tri_o({gpio2_0_tri_o_7,gpio2_0_tri_o_6,gpio2_0_tri_o_5,gpio2_0_tri_o_4,gpio2_0_tri_o_3,gpio2_0_tri_o_2,gpio2_0_tri_o_1,gpio2_0_tri_o_0}),
        .GPIO2_0_tri_t({gpio2_0_tri_t_7,gpio2_0_tri_t_6,gpio2_0_tri_t_5,gpio2_0_tri_t_4,gpio2_0_tri_t_3,gpio2_0_tri_t_2,gpio2_0_tri_t_1,gpio2_0_tri_t_0}),
